"""
Module for fitting the aABC algorithm with general form of the generative models
"""

from simple_abc_general import Model, basic_abc, pmc_abc
...
def fit_withABC(MyModel, data_ac , priorDist, inter_save_direc, inter_filename, datasave_path, filenameSave,\
